...
from mmfreelm.models.hgrn_bit.RotaryEmbedding import RotaryEmbedding, apply_rotary_pos_emb, rotate_half
...
class HGRNBitAttention(nn.Module):
    ...
    use_ternary_rope: bool = False,  # Add this parameter
    ) -> HGRNAttention:
        super().__init__()
...
def forward(
    ...
    **kwargs
    ...
    # Process input with short convolution if enabled
    ...
    # Apply lower bound if specified (skip for first layer)
    ...
    # Handle left-padding if attention mask is provided
    ...
    i, f = apply_rotary_pos_emb(i, f, cos, sin, position_ids)
    
    # Process with recurrent layer
